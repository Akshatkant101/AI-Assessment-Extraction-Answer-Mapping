    ...
    <main className="h-screen w-screen flex flex-col select-none antialiased overflow-hidden bg-[#F3F4F6]">
      {!processingSessionId ? (
        ...
        <div className="h-full w-full flex flex-col bg-[#F3F4F6] overflow-hidden">
          ...
          <div className="flex-1 flex overflow-hidden p-3 sm:p-0">
            ...
            <div className="flex-1 flex items-center justify-center p-3 sm:p-6 overflow-hidden">
              <div className="bg-white rounded-[32px] sm:rounded-none w-full max-w-md h-[85%] sm:h-full flex flex-col items-center justify-center p-6 sm:p-12 border border-slate-200/70 sm:border-none shadow-2xs sm:shadow-none">
